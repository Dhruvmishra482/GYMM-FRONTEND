    ...
    () => [
      {
        ...
        features: [
          ...
          {
            name: "Member dashboard with profiles & photos",
            included: true,
            highlight: false,
          },
          {
            name: "Add & search active members",
            included: true,
            highlight: false,
          },
          {
            name: "Due notifications to owner",
            included: true,
            highlight: true,
          },
          {
            name: "Basic fee tracking & payment status",
            included: true,
            highlight: false,
          },
          {
            name: "Member contact details & emergency info",
            included: true,
            highlight: false,
          },
      ...
      },
      {
        ...
        features: [
          ...
          {
            name: "Powered by every feature of the Basic Plan, and more",
            included: true,
            highlight: true,
          },
          {
          ...
          {
            name: "Predictive fee tracking & insights",
            included: true,
            highlight: true,
          },
          {
            name: "Inactive member alerts (track who hasn't visited)",
            included: true,
            highlight: true,
          },
          {
            name: "Advanced analytics (growth + revenue trends)",
            included: true,
            highlight: true,
          },
          {
            name: "AI Diet Plan based on progress & attendance",
            included: true,
            highlight: true,
          },
          {
          ...
          {
            name: "Bulk WhatsApp messaging for announcements",
            included: true,
            highlight: true,
          },
          {
      ...
      },
      {
        name: "Enterprise",
        tagline:
          "For fitness empires that want AI + automation at the highest level",
        description:
        ...
        features: [
          {
            name: "Unlimited members (no cap)",
            included: true,
            highlight: true,
          },
          {
            name: "Powered by every feature of the Advanced Plan, and more",
            included: true,
            highlight: true,
          },
          {
            name: "Manage multiple branches/locations from one dashboard",
            included: true,
            highlight: true,
          },
          {
            name: "Automated daily WhatsApp reports (joins, renewals, dues, inactive)",
            included: true,
            highlight: true,
          },
          {
            name: "Smart WhatsApp fee reminders (3 days before + due date with QR)",
            included: true,
            highlight: true,
          },
          {
            name: "AI-powered crowd prediction & time-slot optimization",
            included: true,
            highlight: true,
          },
          {
            name: "Member birthday & anniversary notifications",
            included: true,
            highlight: false,
          },
          {
            name: "Advanced AI workout plans with progress tracking",
            included: true,
            highlight: true,
          },
          {
            name: "Personalized nutrition tracking with meal suggestions",
            included: true,
            highlight: true,
          },
          {
            name: "Full inactive/old member history with re-activation campaigns",
            included: true,
            highlight: true,
          },
          {
            name: "Advanced expense & profit tracking",
            included: true,
            highlight: true,
          },
          {
            name: "Automated class scheduling & booking system",
            included: true,
            highlight: true,
          },
          {
            name: "Advanced security & compliance features",
            included: true,
            highlight: true,
          },
          {
            name: "Dedicated success manager (priority WhatsApp + phone support)",
            included: true,
            highlight: true,
          },
          {
            name: "Early access to new premium features",
            included: true,
            highlight: true,
          },
          {
        ...
        <div className="container px-6 mx-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center justify-center mb-16">
              <div
                className={`p-2 border rounded-2xl bg-white/10 backdrop-blur-lg border-white/20 transition-opacity duration-300 ${
            ...
            {plans.map((plan, index) => (
              <Suspense key={index} fallback={<PricingCardSkeleton />}>
                <div
                  ...
                  onMouseEnter={() =>
                    !plan.comingSoon && handleCardHover(index)
                  }
                  onMouseLeave={handleCardLeave}
                >
                  {/* Coming Soon Overlay */}
                  {plan.comingSoon && (
                    <div className="absolute inset-0 z-30 flex items-center justify-center backdrop-blur-sm bg-black/60 rounded-2xl">
                      <div className="text-center px-6">
                        <div className="w-24 h-24 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl animate-pulse">
                      ...
                      <div className="mb-6 text-center">
                        ...
                        <div className="mb-6">
                          ...
                          {billingPeriod !== "monthly" &&
                            pricingConfig[plan.name][billingPeriod]?.savings >
                              0 && (
            ...
            <div className="container px-6 mx-auto">
              ...
              <div className="grid gap-12 md:grid-cols-3">
                {[...Array(3)].map((_, i) => (
                  <div
                    key={i}
                    className="p-8 border bg-white/5 backdrop-blur-lg rounded-3xl border-white/10 animate-pulse"
                  >
