      ...
      <div className={headerClass}>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            <button
              onClick={handleBack}
              className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg flex items-center gap-2 transition-colors"
          ...
          <button
            ...
            disabled={loading}
            className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 disabled:bg-blue-400 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors"
    ...
    return (
      <div className={cardClass}>
        <div className="flex items-center">
          <div className={`p-2 ${color.bg} rounded-lg`}>{icon}</div>
          <div className="ml-4">
...
const ErrorBanner = React.memo(
  ({ error, onRefresh }) => {
    ...
    return (
      <div
        className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 animate-in fade-in duration-300"
        role="alert"
      >
        <div className="flex items-center">
          <svg
