        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              />
              <h1 className="text-2xl font-bold pl-4 ">FitTracker</h1>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mb-12">
              ...
              <p className="text-xl text-gray-300 mb-6 max-w-2xl mx-auto">
                You're just one step away from accessing powerful gym management
                features. Subscribe now to unlock your complete dashboard and
                start managing your members efficiently.
              </p>
              ...
              <div className="inline-flex items-center bg-orange-500/10 border border-orange-500/20 rounded-lg px-4 py-2 mb-8">
                ...
                <span className="text-orange-300">
                  Current Plan:{" "}
                  {subscriptionStatus?.plan || "No Active Subscription"}
                </span>
              </div>
            </div>
            ...
            <div className="max-w-md mx-auto bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20 mb-8">
              ...
              >
                <span>
                  Start Your Journey - ₹{currentPrice.toLocaleString()}
                </span>
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="bg-white/5 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-gray-400">
                  Get started immediately after payment. No waiting, no setup
                  fees.
                </p>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-gray-400">
                  Join hundreds of gym owners who've streamlined their
                  operations.
                </p>
              </div>
            ...
            <div className="mt-12 max-w-2xl mx-auto">
              <p className="text-gray-400 text-sm">
                🔒 Your payment is secured with bank-level encryption. We use
                Razorpay's secure payment gateway trusted by millions.
              </p>
            </div>
          </div>
        </div>
