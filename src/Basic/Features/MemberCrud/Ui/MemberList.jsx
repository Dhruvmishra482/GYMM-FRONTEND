        ...
        <div className="px-3 sm:px-6 py-3 sm:py-4 mx-auto max-w-7xl">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="hidden md:block flex-1 max-w-2xl mx-4">
              <div className="relative group">
                ...
                <input
                  ...
                  defaultValue={searchTerm}
                  onChange={(e) => debouncedSearch(e.target.value)}
                  className="w-full py-2.5 pl-10 pr-4 transition-all border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-blue-400 hover:shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <button
                onClick={() => setShowMobileSearch(!showMobileSearch)}
                className="p-2 md:hidden text-gray-600 transition-all duration-200 rounded-lg hover:text-blue-600 hover:bg-blue-100"
              >
                <Search className="w-5 h-5" />
              </button>
              ...
              <button
                onClick={handleAddMember}
                className="flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-medium text-white transition-all duration-200 rounded-lg shadow-md bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 hover:scale-105 hover:shadow-lg"
              >
              ...
              <div className="relative" ref={profileRef}>
                <button
                  onClick={() => setIsProfileOpen(!isProfileOpen)}
                  className="flex items-center gap-1 sm:gap-2 p-1.5 sm:p-2 transition-all duration-200 rounded-lg hover:bg-blue-100 group"
                >
                  <div className="w-8 h-8 sm:w-9 sm:h-9 overflow-hidden transition-colors border-2 border-blue-200 rounded-full group-hover:border-blue-400">
                    {user?.profileImage ? (
                      <img
                        src={user.profileImage}
                        alt={getOwnerDisplayName()}
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600">
                ...
                {filteredAndSortedMembers.length !== stats.totalMembers && (
                  <span className="font-medium text-blue-600">
                    {" "}
                    ({filteredAndSortedMembers.length} of {stats.totalMembers}{" "}
                    shown)
                  </span>
                )}
              </p>
